...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-29-6.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-31-2.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-31-3.png)<!-- -->
...
\#\#Make IPA network to output to Cytoscape for Adult vs
Fetal
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-34-2.png)<!-- -->
\#\# GO
graph
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-38-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-38-2.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-45-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-47-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-48-1.png)<!-- -->
\#\#\# miR HM
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-49-1.png)<!-- -->
...
![](Human_GPC_Aging_Analysis_files/figure-gfm/unnamed-chunk-50-1.png)<!-- -->
...
```
    ...
    ##  [3] scales_1.1.1                SCENIC_1.1.2-2             
    ##  [5] miRBaseConverter_1.11.1     miRNAtap_1.18.0            
    ##  [7] AnnotationDbi_1.46.1        pd.mirna.3.0_3.12.0        
    ##  [9] DBI_1.1.0                   oligo_1.48.0               
    ## [11] oligoClasses_1.46.0         RSQLite_2.2.0              
    ## [13] Biostrings_2.52.0           XVector_0.24.0             
    ## [15] affy_1.62.0                 DT_0.11                    
    ## [17] RcisTarget_1.4.0            UpSetR_1.4.0               
    ## [19] MAST_1.10.0                 SingleCellExperiment_1.6.0 
    ## [21] Seurat_3.1.1                stringr_1.4.0              
    ## [23] plyr_1.8.6                  magrittr_1.5               
    ## [25] patchwork_1.0.0             EnhancedVolcano_1.3.5      
    ## [27] ggrepel_0.8.2               dplyr_1.0.2                
    ## [29] ggVennDiagram_0.3           igraph_1.2.5               
    ## [31] tidyr_1.1.2                 data.table_1.12.8          
    ## [33] ggfortify_0.4.8             Hmisc_4.3-0                
    ## [35] ggplot2_3.3.2               Formula_1.2-3              
    ## [37] survival_3.1-7              lattice_0.20-38            
    ## [39] edgeR_3.26.8                limma_3.40.6               
    ## [41] DESeq2_1.24.0               SummarizedExperiment_1.14.1
    ## [43] DelayedArray_0.10.0         BiocParallel_1.18.1        
    ## [45] matrixStats_0.56.0          Biobase_2.44.0             
    ## [47] GenomicRanges_1.36.1        GenomeInfoDb_1.20.0        
    ## [49] IRanges_2.18.3              S4Vectors_0.22.1           
    ## [51] BiocGenerics_0.30.0         biomaRt_2.40.5             
    ## [53] tximport_1.12.3             readr_1.3.1                
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] R.methodsS3_1.7.1      acepack_1.4.1          bit64_4.0.5           
    ##   [4] knitr_1.29             irlba_2.3.3            R.utils_2.9.2         
    ...
    ##  [25] caTools_1.17.1.3       geneplotter_1.62.0     htmlwidgets_1.5.1     
    ##  [28] futile.logger_1.4.3    feather_0.3.5          purrr_0.3.4           
    ##  [31] ellipsis_0.3.1         RSpectra_0.16-0        backports_1.1.9       
    ##  [34] annotate_1.62.0        gbRd_0.4-11            RcppParallel_4.4.4    
    ##  [37] vctrs_0.3.4            ROCR_1.0-7             abind_1.4-5           
    ##  [40] cachem_1.0.5           withr_2.4.2            checkmate_1.9.4       
    ##  [43] sctransform_0.2.0      prettyunits_1.1.1      cluster_2.1.0         
    ##  [46] ape_5.4-1              lazyeval_0.2.2         crayon_1.3.4          
    ##  [49] genefilter_1.66.0      pkgconfig_2.0.3        labeling_0.3          
    ##  [52] units_0.6-5            nlme_3.1-142           blme_1.0-4            
    ##  [55] nnet_7.3-12            rlang_0.4.11           globals_0.12.4        
    ##  [58] lifecycle_1.0.0        affyio_1.54.0          rsvd_1.0.2            
    ##  [61] VennDiagram_1.6.20     lmtest_0.9-37          graph_1.62.0          
    ##  [64] Matrix_1.2-18          boot_1.3-23            zoo_1.8-6             
    ##  [67] base64enc_0.1-3        ggridges_0.5.1         png_0.1-7             
    ##  [70] viridisLite_0.3.0      bitops_1.0-6           R.oo_1.23.0           
    ##  [73] KernSmooth_2.23-16     blob_1.2.1             classInt_0.4-2        
    ##  [76] memoise_2.0.0          GSEABase_1.46.0        ica_1.0-2             
    ##  [79] gplots_3.0.1.1         bibtex_0.4.2.2         gdata_2.18.0          
    ...
    ##  [91] htmlTable_1.13.2       formatR_1.7            mgcv_1.8-31           
    ##  [94] MASS_7.3-51.4          tidyselect_1.1.0       stringi_1.4.6         
    ##  [97] yaml_2.2.1             locfit_1.5-9.4         latticeExtra_0.6-28   
    ## [100] grid_3.6.1             tools_3.6.1            future.apply_1.3.0    
    ## [103] rstudioapi_0.13        foreach_1.5.0          foreign_0.8-72        
    ## [106] AUCell_1.6.1           gridExtra_2.3          farver_2.0.3          
    ## [109] Rtsne_0.15             digest_0.6.25          BiocManager_1.30.10   
    ## [112] shiny_1.5.0            ff_2.2-14              proto_1.0.0           
    ## [115] Rcpp_1.0.5             SDMTools_1.1-221.2     later_1.1.0.1         
    ## [118] RcppAnnoy_0.0.14       httr_1.4.2             sf_0.8-0              
    ## [121] npsurv_0.4-0           Rdpack_0.11-0          colorspace_1.4-1      
    ## [124] XML_3.99-0.3           reticulate_1.13        splines_3.6.1         
    ## [127] uwot_0.1.4             plotly_4.9.1           xtable_1.8-4          
    ## [130] jsonlite_1.7.1         nloptr_1.2.1           futile.options_1.0.1  
    ## [133] R6_2.4.1               gsubfn_0.7             pillar_1.4.6          
    ## [136] htmltools_0.5.0        mime_0.9               affxparser_1.56.0     
    ## [139] glue_1.4.2             fastmap_1.0.1          minqa_1.2.4           
    ## [142] class_7.3-15           codetools_0.2-16       utf8_1.1.4            
    ## [145] tsne_0.1-3             tibble_3.0.3           sqldf_0.4-11          
    ## [148] leiden_0.3.1           gtools_3.8.1           rmarkdown_1.18        
    ## [151] munsell_0.5.0          e1071_1.7-3            GenomeInfoDbData_1.2.1
    ## [154] iterators_1.0.12       reshape2_1.4.4         gtable_0.3.0
